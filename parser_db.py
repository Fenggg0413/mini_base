...
def p_expr_sellist_second(t):
    ...
    t[1]=common_db.Node('TCNAME',[t[1]],t[1])
...
def p_expr_sellist_third(t):
    'SelList : STAR'
    t[1] = common_db.Node('STAR', None, '*')  # 构建语法树节点，value为 '*'
    t[0] = common_db.Node('SelList', [t[1]])
    return t
...
def p_expr_fromlist_second(t):
    'FromList : TCNAME'
    t[1]=common_db.Node('TCNAME',[t[1]], t[1])  # the second parameter is the variable name
...
def p_expr_condition(t):
    ...
    t[1]=common_db.Node('TCNAME',[t[1]],t[1])  # the second parameter is the variable name
    t[2]=common_db.Node('=',None,'=')
    t[3]=common_db.Node('CONSTANT',[t[3]],t[3])  # the second parameter is the variable name
